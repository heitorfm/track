...
#ifndef TRACK_EXECUTIONERROR_HPP
#define TRACK_EXECUTIONERROR_HPP
...
public:
	explicit ExecutionError() = default;
	explicit ExecutionError(string msg): message(std::move(msg)) {}
	string what() {
		return message;
	}
...
#endif //TRACK_EXECUTIONERROR_HPP
